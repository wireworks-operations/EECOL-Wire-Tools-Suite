...
### Continuous Improvement Protocol (2025-10-31)
Two specialized files for operational learning and self-improvement:

7. `raw_reflection_log.md`
   - Detailed, timestamped logging of task reflections
   - Raw observations from completed work
   - Candidates for consolidation into actionable knowledge

8. `consolidated_learnings.md`
   - Curated, summarized insights from raw reflections
